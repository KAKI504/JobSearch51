    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/resumes/create", "/resumes/{id}/status").authenticated()
                        .requestMatchers("/vacancies/create", "/vacancies/{id}/status").authenticated()
                        .requestMatchers("/responses/**").authenticated()
                        .requestMatchers("/messages/**").authenticated()
                        .requestMatchers("/reviews/**").authenticated()
                        .requestMatchers("/resumes/active", "/vacancies").permitAll()
